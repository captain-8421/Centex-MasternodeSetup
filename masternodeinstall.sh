...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='cntxcoin.conf'
CONFIGFOLDER='/root/.cntxcoin'
COIN_DAEMON='cntxcoind'
COIN_CLI='cntxcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/Centexio/Centex/releases/download/v1.0.2/centex_v1.0.2_ubuntu_16.04_x64.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='cntxcoind'
COIN_EXPLORER='http://explorer.centex.io:3001/'
COIN_PORT=37323
RPC_PORT=37322
